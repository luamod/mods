...
describe("mods.tbl", function()
  ...
  local tests = {
    -----fname---|----------args----------|--expected---|-same_ref?---
    { "clear"    , { a1_b2_c3           } , nil         , true    },
    { "copy"     , { a1_b2_c3           } , a1_b2_c3    ,         },
    { "count"    , { {}                 } , 0           ,         },
    { "count"    , { a1_b2_c3           } , 3           ,         },
    { "deepcopy" , { a1_b2_c3           } , a1_b2_c3    ,         },
    { "filter"   , { a1_b2_c3, gt_2     } , { c = 3 }   ,         },
    { "filter"   , { a1_b2_c3, gt_5     } , {}          ,         },
    { "filter"   , { Aa_Bb_Cc, not_b    } , Aa_Cc       ,         },
    { "find_if"  , { a1_b2_cc, is_equal } , "c"         ,         },
    { "find"     , { a1_b2_c3, "2"      } , nil         ,         },
    { "find"     , { a1_b2_c3, 2        } , "b"         ,         },
    { "find"     , { abc, "b"           } , 2           ,         },
    { "get"      , { loc                } , loc         , true    },
    { "get"      , { loc, "a", "b", "c" } , loc.a.b.d   ,         },
    { "get"      , { loc, "a", "d", "d" } , nil         ,         },
    { "invert"   , { aA_bB_cC           } , Aa_Bb_Cc    ,         },
    { "invert"   , { Aa_Bb_Cc           } , aA_bB_cC    ,         },
    { "isempty"  , { {}                 } , true        ,         },
    { "isempty"  , { abc                } , false       ,         },
    { "keys"     , { a1_b2_c3,          } , abc         ,         },
    { "map"      , { a1_b2_c3, multi    } , a2_b4_c6    ,         },
    { "pairmap"  , { a1_b2_c3, concat   } , aa1_bb2_cc3 ,         },
    { "update"   , { x1_y2, y3_z4       } , x1_y3_z4    , true    },
    { "update"   , { y3_z4, x1_y2       } , x1_y2_z4    , true    },
    { "values"   , { a1_b2_c3           } , n123        ,         },
  }
  -- stylua: ignore end
  ...
  for i = 1, #tests do
    ...
    it(fname .. "() returns correct value", function()
      ...
      if expected == nil then
        actual = same_ref and args[1] or res
        expected = actual
      end

      if fname == "keys" or fname == "values" then
        table.sort(actual)
      end

      assert.are_same(expected, actual)
      if same_ref then
        assert.are_equal(args[1], actual, "Expected same table reference")
      else
        assert.not_equal(args[1], actual, "Expected different table reference")
      end
    end)
  end
