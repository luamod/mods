...
describe("mods.str", function()
  ...
  local tests=  {
    ...
    { "lstrip"       , "xxabc"         , { "xy"                } , "abc"               ,      },
    { "partition"    , "-abc"          , { "-"                 } , { "", "-", "abc" }  , true },
    { "partition"    , "a-b-c"         , { "-"                 } , { "a", "-", "b-c" } , true },
    { "partition"    , "abc-"          , { "-"                 } , { "abc", "-", "" }  , true },
    { "partition"    , "abc"           , { "-"                 } , { "abc", "", "" }   , true },
    ...
    { "rjust"        , "hi"            , { 4                   } , "  hi"              ,      },
    { "rjust"        , "hi"            , { 4, "."              } , "..hi"              ,      },
    { "rpartition"   , "-abc"          , { "-"                 } , { "", "-", "abc" }  , true },
    { "rpartition"   , "a-b-c"         , { "-"                 } , { "a-b", "-", "c" } , true },
    { "rpartition"   , "abc-"          , { "-"                 } , { "abc", "-", "" }  , true },
    { "rpartition"   , "abc"           , { "-"                 } , { "", "", "abc" }   , true },
  ...
  for i = 1, #tests do
    local fname, args = unpack(tests[i])
    it(fname .. "() returns mods.List", function()
      local res = str[fname](unpack(args))
      assert.is_true(getmetatable(res) == List)
    end)
  end
end)
