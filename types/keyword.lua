...
---Return Lua keywords as a [`mods.List`](https://luamod.github.io/mods/modules/list) of strings.
---
---```lua
...
---Return Lua keywords as a [`mods.Set`](https://luamod.github.io/mods/modules/set) of strings.
---
---```lua
