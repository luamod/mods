...
Currently supported versions are the latest release on the `main` branch.
...
If you cannot use GitHub advisories, open a private issue and clearly mark it as security-sensitive.
